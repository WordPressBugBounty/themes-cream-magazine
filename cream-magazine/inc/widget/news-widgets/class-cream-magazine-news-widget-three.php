<?php
/**
 * Widget class definition for CM Full: News Widget 3.
 *
 * @since 1.0.0
 *
...
/**
 * Widget class - Cream_Magazine_News_Widget_Three.
 *
 * @since 1.0.0
 *
 * @package Cream_Magazine
...
class Cream_Magazine_News_Widget_Three extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct(
			'cream-magazine-news-widget-three',
			esc_html__( 'CM Full: News Widget 3', 'cream-magazine' ),
			array(
