<?php
/**
 * Widget class definition for CM Full: News Widget 2.
 *
 * @since 1.0.0
 *
...
/**
 * Widget class - Cream_Magazine_News_Widget_Two.
 *
 * @since 1.0.0
 *
 * @package Cream_Magazine
...
class Cream_Magazine_News_Widget_Two extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct(
			'cream-magazine-news-widget-two',
			esc_html__( 'CM Full: News Widget 2', 'cream-magazine' ),
			array(
