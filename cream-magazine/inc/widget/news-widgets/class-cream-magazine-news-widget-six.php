<?php
/**
 * Widget class definition for CM Half: News Widget 6.
 *
 * @since 1.0.0
 *
...
/**
 * Widget class - Cream_Magazine_News_Widget_Six.
 *
 * @since 1.0.0
 *
 * @package Cream_Magazine
...
class Cream_Magazine_News_Widget_Six extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct(
			'cream-magazine-news-widget-six',
			esc_html__( 'CM Half: News Widget 6', 'cream-magazine' ),
			array(
