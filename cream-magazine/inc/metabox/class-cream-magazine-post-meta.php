	...
	class Cream_Magazine_Post_Meta {
		...
		public function register_post_meta() {
			...
			add_meta_box(
				...
				esc_html__( 'Sidebar Position', 'cream-magazine' ),
		...
		public function save_sidebar_position_meta() {
			...
			if (
				! isset( $_POST['cream_magazine_sidebar_position_meta_nonce_id'] ) ||
				! wp_verify_nonce( sanitize_key( $_POST['cream_magazine_sidebar_position_meta_nonce_id'] ), 'cream_magazine_sidebar_position_meta_nonce' )
			) {
				return;
			}
