wp.customize.controlConstructor['cream-magazine-typography'] = wp.customize.Control.extend({
    ...
    ready: function () {
        ...
        let fontFamilySelectEle = control.container.find('#cream-magazine-font-family-select-' + control.id);
        if (fontFamilySelectEle.length > 0) {
            new SlimSelect({
                select: '#cream-magazine-font-family-select-' + control.id,
                showSearch: true,
        ...
        let fontVariantsSelectEle = control.container.find('#cream-magazine-font-variants-select-' + control.id);
        if (fontVariantsSelectEle.length > 0) {
            new SlimSelect({
                select: '#cream-magazine-font-variants-select-' + control.id,
                showSearch: false,
                contentPosition: 'relative',
                settings: {
                    openPosition: 'down' // 'auto', 'up' or 'down'
        ...
        let fontWeightSelectEle = control.container.find('#cream-magazine-font-weight-select-' + control.id);
        if (fontWeightSelectEle.length > 0) {
            new SlimSelect({
                select: '#cream-magazine-font-weight-select-' + control.id,
                showSearch: false,
                contentPosition: 'relative',
                settings: {
                    openPosition: 'down' // 'auto', 'up' or 'down'
        ...
        fontFamilySelectEle.on('change', function () {
            ...
            let fontVariantsSelectWrapperEle = jQuery('#cream-magazine-google-variants-select-wrapper-' + thisFontFamilySelectEle.data('control'));
        ...
        body.on('change', '#cream-magazine-font-family-select-' + control.id, function (event) {
        ...
        body.on('change', '#cream-magazine-font-variants-select-' + control.id, function (event) {
            event.preventDefault();
            let thisEle = jQuery(this);
        ...
        body.on('change', '#cream-magazine-font-weight-select-' + control.id, function (event) {
            event.preventDefault();
            let thisEle = jQuery(this);
        ...
        devices.forEach(function (device) {
            ...
            // On font-size change.
            body.on('change', '#cream-magazine-' + device + '-font-size-' + control.id, function (event) {
                event.preventDefault();
                let thisEle = jQuery(this);
                let settingValue = getSettingValue(control.id);
            ...
            body.on('change', '#cream-magazine-' + device + '-font-size-unit-input-' + control.id, function (event) {
                event.preventDefault();
                let thisEle = jQuery(this);
                let settingValue = getSettingValue(control.id);
                let targetDevice = thisEle.data('device');
            ...
            body.on('change', '#cream-magazine-' + device + '-line-height-' + control.id, function (event) {
                event.preventDefault();
                let thisEle = jQuery(this);
                let settingValue = getSettingValue(control.id);
                let targetDevice = thisEle.data('device');
            ...
            body.on('change', '#cream-magazine-' + device + '-letter-spacing-' + control.id, function (event) {
                event.preventDefault();
                let thisEle = jQuery(this);
                let settingValue = getSettingValue(control.id);
                let targetDevice = thisEle.data('device');
            ...
            body.on('change', '#cream-magazine-' + device + '-letter-spacing-unit-input-' + control.id, function (event) {
                event.preventDefault();
                let thisEle = jQuery(this);
                let settingValue = getSettingValue(control.id);
                let targetDevice = thisEle.data('device');
        ...
        body.on('change', '#cream-magazine-typography-font-style-input-' + control.id, function (event) {
            event.preventDefault();
            let thisEle = jQuery(this);
            let settingValue = getSettingValue(control.id);
        ...
        body.on('change', '#cream-magazine-typography-text-transform-input-' + control.id, function (event) {
            event.preventDefault();
            let thisEle = jQuery(this);
            let settingValue = getSettingValue(control.id);
        ...
        let fontSizeSliders = [
            control.container.find('.cream-magazine-slider.cream-magazine-slider-font-size.desktop-slider'),
            control.container.find('.cream-magazine-slider.cream-magazine-slider-font-size.tablet-slider'),
            control.container.find('.cream-magazine-slider.cream-magazine-slider-font-size.mobile-slider'),
            control.container.find('.cream-magazine-slider.cream-magazine-slider-font-size.normal-slider'),
            control.container.find('.cream-magazine-slider.cream-magazine-slider-line-height.desktop-slider'),
            control.container.find('.cream-magazine-slider.cream-magazine-slider-line-height.tablet-slider'),
            control.container.find('.cream-magazine-slider.cream-magazine-slider-line-height.mobile-slider'),
            control.container.find('.cream-magazine-slider.cream-magazine-slider-line-height.normal-slider'),
            control.container.find('.cream-magazine-slider.cream-magazine-slider-letter-spacing.desktop-slider'),
            control.container.find('.cream-magazine-slider.cream-magazine-slider-letter-spacing.tablet-slider'),
            control.container.find('.cream-magazine-slider.cream-magazine-slider-letter-spacing.mobile-slider'),
            control.container.find('.cream-magazine-slider.cream-magazine-slider-letter-spacing.normal-slider')
        ];

        // Initialize sliders using jQuery slider UI.
        fontSizeSliders.forEach(function (fontSizeSlider) {
            let fontSizeSliderInput = fontSizeSlider.next('.cream-magazine-slider-input').find('input.slider-input');
        ...
        body.on('click', '#cream-magazine-font-size-reset-' + control.id, function (event) {
            event.preventDefault();
            let controlID = jQuery(this).data('control');
            let devices = ['desktop', 'tablet', 'mobile', 'normal'];
            devices.forEach(function (device) {
                // Reset font-size input value.
                let fontSizeInputEle = jQuery('#cream-magazine-' + device + '-font-size-' + controlID);
                fontSizeInputEle.val(fontSizeInputEle.data('default')).trigger('change');
                // Reset font-size unit input value.
                let fontSizeUnitInputEle = jQuery('#cream-magazine-' + device + '-font-size-unit-input-' + controlID);
                fontSizeUnitInputEle.val(fontSizeUnitInputEle.data('default')).trigger('change');
                // Reset font-size unit button text.
                let fontSizeUnitButtonEle = jQuery('#cream-magazine-' + device + '-font-size-unit-' + controlID);
                fontSizeUnitButtonEle.find('span').html(fontSizeUnitInputEle.data('default'));
            });
        });

        // On line-height reset event.
        body.on('click', '#cream-magazine-line-height-reset-' + control.id, function (event) {
            event.preventDefault();
            let devices = ['desktop', 'tablet', 'mobile', 'normal'];
            devices.forEach(function (device) {
                // Reset line-height input value.
                let lineHeightInputEle = jQuery('#cream-magazine-' + device + '-line-height-' + control.id);
                lineHeightInputEle.val(lineHeightInputEle.data('default')).trigger('change');
            });
        });

        // On letter-spacing reset event.
        body.on('click', '#cream-magazine-letter-spacing-reset-' + control.id, function (event) {
            event.preventDefault();
            let devices = ['desktop', 'tablet', 'mobile', 'normal'];
            devices.forEach(function (device) {
                // Reset letter-spacing input value.
                let letterSpacingInputEle = jQuery('#cream-magazine-' + device + '-letter-spacing-' + control.id);
                letterSpacingInputEle.val(letterSpacingInputEle.data('default')).trigger('change');
                // Reset letter-spacing unit input value.
                let letterSpacingUnitInputEle = jQuery('#cream-magazine-' + device + '-letter-spacing-unit-input-' + control.id);
                letterSpacingUnitInputEle.val(letterSpacingUnitInputEle.data('default')).trigger('change');
                // Reset letter-spacing unit button text.
                let letterSpacingUnitButtonEle = jQuery('#cream-magazine-' + device + '-letter-spacing-unit-' + control.id);
        ...
        body.on('click', '#cream-magazine-text-style-reset-' + control.id, function (event) {
            event.preventDefault();
            // Reset text-style input value.
            let textStyleInputEle = jQuery('#cream-magazine-typography-font-style-input-' + control.id);
            ...
            let textStyleButton = jQuery('#cream-magazine-font-style-' + textStyleDefaultValue + '-' + control.id);
            textStyleButton.addClass('active').siblings().removeClass('active');
        });

        // On text-transform reset event.
        body.on('click', '#cream-magazine-text-transform-reset-' + control.id, function (event) {
            event.preventDefault();
            // Reset text-transform input value.
            let textTransformInputEle = jQuery('#cream-magazine-typography-text-transform-input-' + control.id);
            ...
            let textTransformButton = jQuery('#cream-magazine-text-transform-' + textTransformDefaultValue + '-' + control.id);
        ...
        function saveSetting(controlID, newSettingValue) {
            let settingInputEle = jQuery('#cream-magazine-typography-control-value-' + controlID);
