...
if (
	is_active_sidebar( 'home-top-news-area' ) &&
	cream_magazine_get_option( 'cream_magazine_display_top_widget_area' )
) {
	?>
...
if (
	is_active_sidebar( 'home-bottom-news-area' ) &&
	cream_magazine_get_option( 'cream_magazine_display_bottom_widget_area' )
) {
	?>
